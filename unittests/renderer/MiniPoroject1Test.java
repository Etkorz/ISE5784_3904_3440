...
////     */
////    private Scene scene1 = new Scene("Test scene").setSoftShadow(81);
////
////    private Camera camera = new Camera(new Point(800,1100,77), new Vector(-800,-1100,0), new Vector(0,0,1)) //
////            .setVPSize(200, 200).setVPDistance(1000)//
////            .setrayTracer(new SimpleRayTracer(scene1));
////
////    private Material material = new Material().setkD(0.5).setkS(0.5).setShininess(30);
...
////        scene1.geometries.add(new Plane(new Point(1,0,0), new Point(0,1,0), new Point(0,0,0))//
...
////                        .setMaterial(new Material().setkD(0.5).setkS(0.5).setShininess(300)).setEmission(new Color(0,0,0)));
////
////        scene1.geometries.add(leftStand, rightStand, beadsLineOneLeft, beadsLineOneRight, beadsLineTwoLeft, beadsLineTwoRight,//
...
////
////        //region lights
////        scene1.lights.add(new SpotLight(whiteColorLight, new Point(-100,100,150), new Vector(130, -100, -80)).setKl(0.001).setKq(0.0001));
////        scene1.lights.add(new PointLight(whiteColorLight,spPL).setkL(0.05).setkQ(0.0001));
////        scene1.lights.add(new PointLight(whiteColorLight, new Point(0,0,200)).setkL(0.05));
////        //endregion
////        cameraBuilder.setLocation(new Point(0, 0, 1000)).setVpDistance(1000)
////                .setVpSize(200, 200)
