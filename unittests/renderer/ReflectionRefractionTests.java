    ...
    public void myTest() {
        scene.geometries.add( //
                ...
                new Plane(
                        ...
                        .setMaterial(new Material().setkD(0.4).setkS(0.4).setShininess(40)),

        // יצירת עיגול ראשון
        new Sphere(
                new Point(-50, 0, -80), 50d)
                .setEmission(new Color(200, 0, 0))
                .setMaterial(new Material().setkD(0.2).setkS(0.2).setShininess(30)),

        // יצירת עיגול שני המונח קצת על הראשון
         new Sphere(
                new Point(10, 20, -100), 80d)
                .setEmission(new Color(0, 0, 180))
                .setMaterial(new Material().setkD(0.2).setkS(0.2).setShininess(30).setkT(0.4)),

        // יצירת משולש להוספת עניין
        new Triangle(
                new Point(-50, -35, -150),
                new Point(0, 50, -150),
                new Point(150, -50, -45))
